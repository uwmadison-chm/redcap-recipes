...
::: {.callout-tip title="Use the builder"}
The [Survey Timing Builder](builder/) can generate a data dictionary for you. Upload your project XML, select which surveys to track, and download a ready-to-import CSV.
:::
